...
class Crawler:
    ...
    __counter = 0
    headers = {
        'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; WOW64; rv:23.0) Gecko/20100101 Firefox/23.0', 'Cookie': ''}
    __per_page = 30
...
# python crawling.py --word "御坂美琴" --total_page 10 --start_page 1 --per_page 30
